...
# python3 $HOME/subregular_language/main.py --hidden_size $HS --dropout_rate $DR --layers_lstm $LC &

# lstm
# python3 $HOME/subregular_language/main.py --hidden_size 64 --dropout_rate 0.2 --layers_lstm 2 --data $DATA &
python3 $HOME/subregular_language/main.py --hidden_size 64 --dropout_rate 0.2 --layers_lstm 2 --data 10000 &

# lstm+attn
# python3 $HOME/subregular_language/main.py --hidden_size 256 --dropout_rate 0.2 --layers_lstm 2 --data $DATA &
# python3 $HOME/subregular_language/main.py --hidden_size 256 --dropout_rate 0.2 --layers_lstm 2 --data 10000 &

# lstm+attn+act
# python3 $HOME/subregular_language/main.py --hidden_size 128 --dropout_rate 0.5 --layers_lstm 1 --data $DATA &
# python3 $HOME/subregular_language/main.py --hidden_size 128 --dropout_rate 0.5 --layers_lstm 1 --data 10000 &
